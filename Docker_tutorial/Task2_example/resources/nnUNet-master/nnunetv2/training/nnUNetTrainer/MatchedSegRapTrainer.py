...
from nnunetv2.training.nnUNetTrainer.bezier_curve import nonlinear_transformation


class MatchedSegRapTrainer(nnUNetTrainer):
    ...
    def build_network_architecture(architecture_class_name: str,
        ...
        """
        path = "./nnUNet-master/nnunetv2/training/nnUNetTrainer/DFUNet/NetConfig.yaml"
    ...
    def train_step(self, batch: dict) -> dict:
        data = batch['data']
        target = batch['target']
        data = nonlinear_transformation(data)
